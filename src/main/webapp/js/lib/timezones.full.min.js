...
(function($){
  ...
  var Timezone = {
    init : function(cities, formatName){
	  ...
	  var tempCitites = ["Etc/GMT+12","US/Samoa","US/Hawaii","Etc/GMT+9","US/Alaska","America/Los_Angeles","America/Vancouver","America/Costa_Rica","America/Denver","Canada/Mountain","America/Chicago","America/Lima","America/Mexico_City","America/Winnipeg","America/Caracas","America/La_Paz","America/Montreal","America/New_York","America/Puerto_Rico","America/Buenos_Aires","America/Halifax","America/Santiago","America/Sao_Paulo","America/St_Johns","Etc/GMT+2","Etc/GMT+1","Atlantic/Reykjavik","Africa/Lagos","Europe/Dublin","Europe/Lisbon","Europe/London","Africa/Johannesburg","Africa/Tripoli","Europe/Brussels","Europe/Budapest","Europe/Copenhagen","Africa/Addis_Ababa","Africa/Cairo","Asia/Beirut","Europe/Helsinki","Europe/Moscow","Asia/Dubai","Asia/Kabul","Asia/Baku","Asia/Calcutta","Asia/Kathmandu","Asia/Rangoon","Asia/Bangkok","Asia/Chongqing","Asia/Hong_Kong","Asia/Manila","Asia/Taipei","Australia/Perth","Asia/Seoul","Asia/Tokyo","Australia/Adelaide","Australia/Darwin","Australia/Sydney","Etc/GMT-11","Etc/GMT-12","Etc/GMT-13","Etc/GMT-14"];
      for(var key in cities) {
		if(this.inArray(cities[key], tempCitites)){
			this.cities.push({
			  name: cities[key],
